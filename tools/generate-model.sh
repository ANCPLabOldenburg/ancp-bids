...
python3 ~/Downloads/generateDS-2.39.2/generateDS.py -f --export="write etree validate"  --member-specs=dict --always-export-default -o ../bids/model.py ../schema/bids.xsd